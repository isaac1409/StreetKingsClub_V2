...
function LoginModal() {
  ...
  return (
    <div>
      ...
      <div className={`${styles["login-modal"]} ${isModalOpen ? styles["is-open"] : ""}`}>
        <div className={styles["login-modal-container"]}>
          <div className={styles["login-modal-left"]}>
            <h1 className={styles["login-modal-title"]}>Bienvenido!</h1>
            <p className={styles["login-modal-desc"]}>
            ...
            <div className={styles["login-modal-buttons"]}>
              <button className={styles["login-input-button"]}>Iniciar Sesión</button>
            </div>
          </div>
          <div className={styles["login-modal-right"]}>
            <img
          ...
          <button className={styles["login-icon-button"]} onClick={closeModal}>
